Супер, давай сделаем нормальный `README.md`, который можно положить в корень репозитория и дать пользователям:

* **что это за проект**,
* **что он умеет**,
* **как его собрать и запустить**.

Ниже готовый текст, который можно просто скопировать в `README.md` (при желании чуть подправить пути/название).
